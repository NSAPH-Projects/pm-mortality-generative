...
def train_vae(vae, data_loader, num_epochs=10, lr=1e-4, kl_weight=0.1):
...
if __name__ == "__main__":
    ...
    dataloader = initialize_data_loader(components, years, batch_size=10, img_size=(128, 256))

    vae = initialize_vae(device, num_channels=len(components))
    print("VAE model initialized.")
  
    train_vae(vae,dataloader, num_epochs=10, lr=1e-4)
